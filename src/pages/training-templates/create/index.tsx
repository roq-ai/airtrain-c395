...
import { createTrainingTemplate } from 'apiSdk/training-templates';
...
function TrainingTemplateCreatePage() {
  ...
  const handleSubmit = async (values: TrainingTemplateInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createTrainingTemplate(values);
      resetForm();
